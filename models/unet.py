...
from .abstract_model import EncoderDecoder, get_slice, Upscale, UnetDecoderBlock, ConvBottleneck, SumBottleneck, \
    UnetBNDecoderBlock, PathAggregationEncoderDecoder, UnetDoubleDecoderBlock, DPEncoderDecoder, \
    UnetDecoderBlockConcurrent, UnetDecoderBlock1x1
...
class Resnet(EncoderDecoder):
    def __init__(self, num_classes, num_channels, encoder_name, dropout, requires_grad=True):
        if not hasattr(self, 'decoder_type'):
            self.decoder_type = Upscale.upsample_bilinear
        if not hasattr(self, 'first_layer_stride_two'):
        ...
        if not hasattr(self, 'bottleneck_type'):
            self.bottleneck_type = ConvBottleneck
        super().__init__(num_classes, num_channels, encoder_name, dropout=dropout, requires_grad=requires_grad)
...
class Resnet34_bn_sum(Resnet):
    def __init__(self, num_classes, num_channels=3):
        ...
        super().__init__(num_classes, num_channels, encoder_name='resnet34', dropout=None)
...
class Resnet50bn_upsample(Resnet):
    def __init__(self, num_classes, num_channels=3):
        self.decoder_type = Upscale.upsample_bilinear
        self.decoder_block = UnetBNDecoderBlock
        super().__init__(num_classes, num_channels, encoder_name='resnet50', dropout=None)


class Incv3(EncoderDecoder):
    def __init__(self, num_classes, num_channels=3, pretrained=True, requires_grad=True):
        super().__init__(num_classes, num_channels, encoder_name='inceptionv3', requires_grad=requires_grad)
...
class SENet(EncoderDecoder):
    def __init__(self, num_classes, num_channels, encoder_name, dropout):
        if not hasattr(self, 'decoder_type'):
            self.decoder_type = Upscale.upsample_bilinear
        if not hasattr(self, 'first_layer_stride_two'):
            self.first_layer_stride_two = True
        ...
        if not hasattr(self, 'bottleneck_type'):
            self.bottleneck_type = ConvBottleneck
        super().__init__(num_classes, num_channels, encoder_name, dropout=dropout)

    def get_encoder(self, encoder, layer):
        if layer == 0:
            return encoder.layer0
        elif layer == 1:
            return nn.Sequential(encoder.layer0_maxpool,
                                 encoder.layer1)
        elif layer == 2:
            return encoder.layer2
        elif layer == 3:
...
class SE_ResNeXt_50(Resnet):
    def __init__(self, num_classes, num_channels=3, pretrained=True, requires_grad=True):
        self.decoder_type = Upscale.upsample_bilinear
        self.decoder_block = UnetDecoderBlock  # UnetDecoderBlockConcurrentBN  #
        super().__init__(num_classes, num_channels, encoder_name='se_resnext50', dropout=None,
                         requires_grad=requires_grad)


class DenseNet(EncoderDecoder):
    def __init__(self, num_classes, num_channels, encoder_name, dropout, requires_grad=True):
        if not hasattr(self, 'decoder_type'):
            self.decoder_type = Upscale.upsample_bilinear
        if not hasattr(self, 'first_layer_stride_two'):
...
class DenseNet161(DenseNet):
    def __init__(self, num_classes, num_channels=3, pretrained=True, requires_grad=True):
        self.decoder_type = Upscale.upsample_bilinear
        self.decoder_block = UnetDecoderBlockConcurrent
        super().__init__(num_classes, num_channels, encoder_name='densenet161', dropout=None,
                         requires_grad=requires_grad)
...
class DenseNet121(DenseNet):
    def __init__(self, num_classes, num_channels=3):
        self.decoder_type = Upscale.upsample_bilinear
        self.decoder_block = UnetBNDecoderBlock
        super().__init__(num_classes, num_channels, encoder_name='densenet121', dropout=None)
...
class DenseNet169(DenseNet):
    def __init__(self, num_classes, num_channels=3):
        self.decoder_type = Upscale.upsample_bilinear
        self.decoder_block = UnetBNDecoderBlock
        super().__init__(num_classes, num_channels, encoder_name='densenet169', dropout=None)
...
class DenseNet201(DenseNet):
    def __init__(self, num_classes, num_channels=3):
        self.decoder_type = Upscale.upsample_bilinear
        self.decoder_block = UnetBNDecoderBlock
        super().__init__(num_classes, num_channels, encoder_name='densenet201', dropout=None)
...
class ResNeXt50(Resnet):
    def __init__(self, num_classes, num_channels=3):
        self.decoder_type = Upscale.upsample_bilinear
        self.decoder_block = UnetBNDecoderBlock
        super().__init__(num_classes, num_channels, encoder_name='resnext50', dropout=None)
