...
class CatInPlaceABN(nn.Module):
    ...
    def __init__(self, in_chs, norm_act=nn.BatchNorm2d):
...
class LightHeadBlock(nn.Module):
    def __init__(self, in_chs, mid_chs=256, out_chs=256, kernel_size=15, norm_act=nn.BatchNorm2d):
...
class ASPPInPlaceABNBlock(nn.Module):
    def __init__(self, in_chs, out_chs, feat_res=(56, 112),
                 up_ratio=2, aspp_sec=(12, 24, 36), norm_act=nn.BatchNorm2d):
